...
export default function App() {
    ...
    <body>
      ...
      <script>
        ...
        //   // 2. Vẽ bàn tay trái
        //   drawConnectors(canvasCtx, results.leftHandLandmarks, HAND_CONNECTIONS, {color: '#4CD964', lineWidth: 4});
        //   drawLandmarks(canvasCtx, results.leftHandLandmarks, {color: '#FFFFFF', lineWidth: 1, radius: 2});
          
        //   // 3. Vẽ bàn tay phải
        //   drawConnectors(canvasCtx, results.rightHandLandmarks, HAND_CONNECTIONS, {color: '#FFCC00', lineWidth: 4});
